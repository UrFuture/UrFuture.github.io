...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    <a class="navbar-brand" href="index.html">WarwickFoodies</a>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="https://www.warwicksu.com/canopy/">Canopy</a>
            <a class="dropdown-item" href="https://warwick.ac.uk/services/retail/eat-drink/fusion">Fusion</a>
            <a class="dropdown-item" href="https://www.greatukpubs.co.uk/varsitywarwick">Varsity</a>
          </div>
        </li>
        <li class="nav-item">
    ...
    <div id="box1" class="jumbotron">
      ...
      <a class="btn btn-primary btn-lg" href="restaurants.html" role="button">I'm ready for food!</a>
    </div>
  </div>
  ...
  <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="Index_images/cafeOculus.jpg" class="d-block w-100% h-100%" style="max-width:500px; max-height:300px" alt="Café Oculus">
      ...
      <div class="carousel-item">
        <img src="Index_images/CafeLibrary.jpg" class="d-block w-100% h-100%" style="max-width:500px; max-height:300px" alt="Café Library">
        <div id="carouseltext" class="carousel-caption">
        <h3>Café Library</h3>
      ...
      <div class="carousel-item">
        <img src="Index_images/CafeHumanities.jpg" class="d-block w-100% h-100%" style="max-width:500px; max-height:300px" alt="Café Humanities">
        <div id="carouseltext" class="carousel-caption">
  ...
  <div id="chain" class="block">
      <a class="btn btn-secondary btn-lg btn-block" href="#" role="button">Chain Café</a>
      <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="Index_images/pret-a-manger.jpg" class="d-block w-100% h-100%" style="max-width:600px; max-height:300px" alt="Pret A Manger">
            <div id="carouseltext" class="carousel-caption">
             <h3>Pret A Manger</h3>
          ...
          <div class="carousel-item">
            <img src="Index_images/CafeNero.jpg" class="d-block w-100% h-100%" style="max-width:600px; max-height:300px" alt="Caffé Nero" background-repeat: "repeat">
            <div id="carouseltext" class="carousel-caption">
            <h3>Caffé Nero</h3>
          ...
          <div class="carousel-item">
            <img src="Index_images/Aroma.jpg" class="d-block w-100% h-100%" style="max-width:600px; max-height:300px" alt="Aroma">
            <div id="carouseltext" class="carousel-caption">
             <h3>Aroma</h3>
...
<div id="seatdown" class="block">
      <a class="btn btn-secondary btn-lg btn-block" href="#" role="button">Fancy a seat-down meal?</a>
      <div id="carouselExampleControls3" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="Index_images/DirtyDuck.jpg" class="d-block w-100% h-100%" style="max-width:600px; max-height:300px" alt="Dirty Duck">
            <div id="carouseltext" class="carousel-caption">
             <h3>Dirty Duck</h3>
          ...
          <div class="carousel-item">
            <img src="Index_images/fusion-food.jpg" class="d-block w-100% h-100%" style="max-width:600px; max-height:300px" alt="Fusion">
            <div id="carouseltext" class="carousel-caption">
             <h3>Fusion</h3>
...
<div id="drink" class="block">
      <a class="btn btn-secondary btn-lg btn-block" href="#" role="button">Deperately need a drink!</a>
      <div id="carouselExampleControls4" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="Index_images/Tbar.jpg" class="d-block" style="max-width:600px; max-height:300px" alt="Terrace Bar">
            <div id="carouseltext" class="carousel-caption">
             <h3>Terrace Bar</h3>
          ...
          <div class="carousel-item">
            <img src="Index_images/DirtyDuck.jpg" class="d-block" style="max-width:600px; max-height:300px" alt="Dirty Duck">
            <div id="carouseltext" class="carousel-caption">
            <h3>Dirty Duck</h3>
          ...
          <div class="carousel-item">
            <img src="Index_images/Varsity.jpg" class="d-block w-100% h-100%" style="max-width:600px; max-height:300px" alt="Varsity">
            <div id="carouseltext" class="carousel-caption">
             <h3>Varsity</h3>
...
<div id="grab" class="block">
      ...
      <div id="carouselExampleControls5" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="Index_images/Red_rocket.jpg" class="d-block" style="width:600px; max-height:300px" alt="Red Rocket">
            <div id="carouseltext" class="carousel-caption">
             <h3>Red Rocket</h3>
             <p>Good range of sandwiches and hot drinks!</p>
          </div>
        </div>
          <div class="carousel-item">
            <img src="Index_images/breadoven.jpg" class="d-block" style="max-width:600px; max-height:300px" alt="The Bread Oven">
            <div id="carouseltext" class="carousel-caption">
            <h3>The Bread Oven</h3>
            <p>Campus' version of subway!</p>
          </div>
        </div>
      </div>
...
<div id="heat" class="block">
      ...
      <div id="carouselExampleControls7" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="Index_images/fusion-food.jpg" class="d-block w-100 h-100%" style="max-width:1000px; max-height:300px" alt="fusion">
            <div id="carouseltext" class="carousel-caption">
             <h3>Fusion</h3>
          </div>
        </div>
          <div class="carousel-item">
            <img src="Index_images/Aroma.jpg" class="d-block w-100% h-100%" style="max-width:500px; max-height:300px" alt="Aroma">
            <div id="carouseltext" class="carousel-caption">
            <h3>Aroma</h3>
          </div>
        </div>
          <div class="carousel-item">
            <img src="Index_images/university-house-restaurant.jpg" class="d-block w-100% h-100%" style="max-width:500px; max-height:300px" alt="Fusion">
            <div id="carouseltext" class="carousel-caption">
             <h3>University House Cafe</h3>
          </div>
        </div>
